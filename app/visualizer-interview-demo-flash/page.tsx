...
export default function FlashInterviewDemoPage() {
  ...
  return (
    <main className="internal-prep" data-stage={stage.id} style={style}>
      <style>{`
        ...
        .history-card {
          border: 1px solid rgba(49,197,223,0.14);
          border-radius: 16px;
          padding: 11px;
          background: rgba(49,197,223,0.055);
          color: rgba(243,238,228,0.7);
        ...
        .history-card.dim {
          border-color: rgba(243,238,228,0.09);
        ...
        .internal-prep[data-stage="problem"] .signal-card,
        .internal-prep[data-stage="thesis"] .mini-turn,
        .internal-prep[data-stage="thesis"] .loop-output div,
        .internal-prep[data-stage="evidence"] .paper-row,
        .internal-prep[data-stage="builder"] .build-line,
        .internal-prep[data-stage="builder"] .builder-node,
        .internal-prep[data-stage="turns"] .turn-person,
        .internal-prep[data-stage="turns"] .turn-caption div,
        .internal-prep[data-stage="room"] .room-panel,
        .internal-prep[data-stage="room"] .question,
        .internal-prep[data-stage="room"] .answer-strip,
        .internal-prep[data-stage="room"] .room-controls .pill,
        .internal-prep[data-stage="report"] .report-item,
        .internal-prep[data-stage="report"] .verdict {
          transform: translateY(0) scale(1);
          transition: transform 420ms cubic-bezier(.2,.86,.18,1), border-color 420ms ease, box-shadow 420ms ease, background 420ms ease;
        }
        .internal-prep[data-stage="problem"] .signal-card.input { animation: flash-lift-1 5.2s cubic-bezier(.2,.86,.18,1) infinite; }
        .internal-prep[data-stage="problem"] .signal-card.live { animation: flash-lift-2 5.2s cubic-bezier(.2,.86,.18,1) infinite; }
        .internal-prep[data-stage="problem"] .signal-card.output { animation: flash-lift-3 5.2s cubic-bezier(.2,.86,.18,1) infinite; }
        .internal-prep[data-stage="thesis"] .mini-turn:nth-child(1),
        .internal-prep[data-stage="thesis"] .loop-left { animation: flash-lift-1 5.2s cubic-bezier(.2,.86,.18,1) infinite; }
        .internal-prep[data-stage="thesis"] .mini-turn:nth-child(2),
        .internal-prep[data-stage="thesis"] .loop-output div:nth-child(1) { animation: flash-lift-2 5.2s cubic-bezier(.2,.86,.18,1) infinite; }
        .internal-prep[data-stage="thesis"] .mini-turn:nth-child(3),
        .internal-prep[data-stage="thesis"] .loop-output div:nth-child(3) { animation: flash-lift-3 5.2s cubic-bezier(.2,.86,.18,1) infinite; }
        .internal-prep[data-stage="evidence"] .paper-row:nth-of-type(1),
        .internal-prep[data-stage="builder"] .build-line:nth-child(1),
        .internal-prep[data-stage="turns"] .turn-person.ai,
        .internal-prep[data-stage="room"] .room-panel:first-child,
        .internal-prep[data-stage="report"] .verdict { animation: flash-lift-1 5.2s cubic-bezier(.2,.86,.18,1) infinite; }
        .internal-prep[data-stage="evidence"] .paper-row:nth-of-type(3),
        .internal-prep[data-stage="builder"] .build-line:nth-child(2),
        .internal-prep[data-stage="turns"] .turn-caption div:nth-child(2),
        .internal-prep[data-stage="room"] .question,
        .internal-prep[data-stage="report"] .report-item:nth-child(1) { animation: flash-lift-2 5.2s cubic-bezier(.2,.86,.18,1) infinite; }
        .internal-prep[data-stage="evidence"] .paper-row:nth-of-type(6),
        .internal-prep[data-stage="builder"] .builder-node:nth-child(6),
        .internal-prep[data-stage="turns"] .turn-person.candidate,
        .internal-prep[data-stage="room"] .answer-strip,
        .internal-prep[data-stage="report"] .report-item:nth-child(2) { animation: flash-lift-3 5.2s cubic-bezier(.2,.86,.18,1) infinite; }
        .internal-prep[data-stage="room"] .room-controls .pill:nth-child(2) { animation: flash-lift-4 5.2s cubic-bezier(.2,.86,.18,1) infinite; }
        @keyframes flash-lift-1 {
          0%, 7%, 100% { transform: translateY(0) scale(1); border-color: rgba(243,238,228,0.12); box-shadow: none; }
          10%, 25% { transform: translateY(-12px) scale(1.025); border-color: rgba(217,162,77,0.38); box-shadow: 0 22px 70px rgba(0,0,0,0.32), 0 0 34px rgba(217,162,77,0.16); }
        }
        @keyframes flash-lift-2 {
          0%, 30%, 100% { transform: translateY(0) scale(1); border-color: rgba(243,238,228,0.12); box-shadow: none; }
          34%, 49% { transform: translateY(-12px) scale(1.025); border-color: rgba(49,197,223,0.38); box-shadow: 0 22px 70px rgba(0,0,0,0.32), 0 0 34px rgba(49,197,223,0.16); }
        }
        @keyframes flash-lift-3 {
          0%, 55%, 100% { transform: translateY(0) scale(1); border-color: rgba(243,238,228,0.12); box-shadow: none; }
          59%, 74% { transform: translateY(-12px) scale(1.025); border-color: rgba(127,226,174,0.38); box-shadow: 0 22px 70px rgba(0,0,0,0.32), 0 0 34px rgba(127,226,174,0.16); }
        }
        @keyframes flash-lift-4 {
          0%, 76%, 100% { transform: translateY(0) scale(1); border-color: rgba(243,238,228,0.14); box-shadow: none; }
          80%, 92% { transform: translateY(-8px) scale(1.035); border-color: rgba(217,162,77,0.38); box-shadow: 0 16px 44px rgba(0,0,0,0.28), 0 0 28px rgba(217,162,77,0.14); }
        }
        .internal-prep[data-stage="problem"] .fake-cursor {
          animation: cursor-problem 5.2s cubic-bezier(.2,.86,.18,1) infinite;
        }
        .internal-prep[data-stage="thesis"] .fake-cursor {
          animation: cursor-thesis 5.2s cubic-bezier(.2,.86,.18,1) infinite;
        }
        .internal-prep[data-stage="evidence"] .fake-cursor {
          animation: cursor-evidence 5s cubic-bezier(.2,.86,.18,1) infinite;
        }
        .internal-prep[data-stage="builder"] .fake-cursor {
          animation: cursor-builder 5.2s cubic-bezier(.2,.86,.18,1) infinite;
        }
        .internal-prep[data-stage="turns"] .fake-cursor {
          animation: cursor-turns 5.2s cubic-bezier(.2,.86,.18,1) infinite;
        }
        .internal-prep[data-stage="room"] .fake-cursor {
          animation: cursor-room 5.6s cubic-bezier(.2,.86,.18,1) infinite;
        }
        .internal-prep[data-stage="report"] .fake-cursor {
          animation: cursor-report 5.4s cubic-bezier(.2,.86,.18,1) infinite;
        }
        @keyframes cursor-problem {
          0%, 25% { opacity: 1; transform: translate(248px, -70px); }
          34%, 49% { opacity: 1; transform: translate(506px, -72px); }
          59%, 78% { opacity: 1; transform: translate(762px, -70px); }
          100% { opacity: 1; transform: translate(762px, -70px); }
        }
        @keyframes cursor-thesis {
          0%, 25% { opacity: 1; transform: translate(202px, -42px); }
          34%, 49% { opacity: 1; transform: translate(260px, 122px); }
          59%, 78% { opacity: 1; transform: translate(684px, 138px); }
          100% { opacity: 1; transform: translate(684px, 138px); }
        }
        @keyframes cursor-evidence {
          0%, 25% { opacity: 1; transform: translate(348px, -142px); }
          34%, 49% { opacity: 1; transform: translate(386px, -2px); }
          59%, 78% { opacity: 1; transform: translate(424px, 146px); }
          100% { opacity: 1; transform: translate(424px, 146px); }
        }
        @keyframes cursor-builder {
          0%, 25% { opacity: 1; transform: translate(188px, -64px); }
          34%, 49% { opacity: 1; transform: translate(215px, 38px); }
          59%, 78% { opacity: 1; transform: translate(760px, 134px); }
          100% { opacity: 1; transform: translate(760px, 134px); }
        }
        @keyframes cursor-turns {
          0%, 25% { opacity: 1; transform: translate(258px, -72px); }
          34%, 49% { opacity: 1; transform: translate(500px, 80px); }
          59%, 78% { opacity: 1; transform: translate(742px, -72px); }
          100% { opacity: 1; transform: translate(742px, -72px); }
        }
        @keyframes cursor-room {
          0%, 21% { opacity: 1; transform: translate(238px, -92px); }
          28%, 46% { opacity: 1; transform: translate(530px, -68px); }
          53%, 69% { opacity: 1; transform: translate(548px, 132px); }
          78%, 92% { opacity: 1; transform: translate(310px, 214px); }
          100% { opacity: 1; transform: translate(310px, 214px); }
        }
        @keyframes cursor-report {
          0%, 25% { opacity: 1; transform: translate(238px, -36px); }
          34%, 49% { opacity: 1; transform: translate(566px, -112px); }
          59%, 78% { opacity: 1; transform: translate(752px, -108px); }
          100% { opacity: 1; transform: translate(752px, -108px); }
        }
            ...
            <header className="top">
              <div className="brand">
                ...
                <div>
                  ...
                  <h1>Interactive interview demo</h1>
                </div>
              </div>
                    ...
                    <aside className="room-panel">
                      ...
                      <div className="history-stack">
                        <div className="history-card">
                          <strong>Latest turn</strong>
                          Q: Conversion drop or tracking noise?<br />
                          A: Compare upstream intent and backend order records.
                        </div>
                        <div className="history-card dim">
                          <strong>Prior turn</strong>
                          Candidate separated dashboard movement from event quality.
                        </div>
                        <button className="pill" type="button">Collapse</button>
                      </div>
                    </aside>
                  </section>
                )}
